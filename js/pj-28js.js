...
p2_text_head = document.createTextNode('هنا بإذن الله سأكتب كل ما سوف أقوم بإنجازه في سنة 2022 بإذن الله')
...
console.log(localStorage)
 ...
 for( lee in ch_data.childNodes[2].innerHTML)
 {
    ...
    if( ch_data.childNodes[2].innerHTML.length > ch_data.childNodes[3].innerHTML.length   )
    {
        // console.log('ok')
    }
